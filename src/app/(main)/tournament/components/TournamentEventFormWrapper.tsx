...
import TournamentEventForm from "./TournamentEventForm";
import TournamentEventAccordion from "./TournamentEventAccordion";
import { ITournamentEvent } from "../types/tournament.types";
...
function TournamentEventFormWrapper({
  tournamentId,
  defaultValues,
  onSubmit,
  prevStep,
...
export default TournamentEventFormWrapper;
