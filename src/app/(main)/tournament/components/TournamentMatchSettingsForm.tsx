...
import { InfoCircleIcon } from "@/components/icons/components/InfoCircle";
...
function TournamentMatchSettingsForm({ form, isEdit, defaultValues }: props) {
...
export default TournamentMatchSettingsForm;
