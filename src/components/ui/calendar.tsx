  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous:
          "absolute left-1 !rounded-2xl !opacity-100 !bg-transparent border-0 hover:!bg-[#e50b0d]",
        nav_button_next:
          "absolute right-1 !rounded-2xl !opacity-100 !bg-transparent border-0 hover:!bg-[#e50b0d]",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:!bg-[#e50b0d]"
        ),
