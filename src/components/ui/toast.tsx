...
const toastVariants = cva(
  ...
  // data-[state=open]:sm:slide-in-from-bottom-full // configure placement to be always at the top right
  {
    variants: {
      variant: {
        default:
        ...
        warn: "warn group border-yellow-500 bg-yellow-500 text-slate-50 dark:border-yellow-900 dark:bg-yellow-900 dark:text-slate-50",
        success:
